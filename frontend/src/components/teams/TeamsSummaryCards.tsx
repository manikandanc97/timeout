...
export default function TeamsSummaryCards({ loading, summary }: Props) {
  ...
  return (
    ...
    >
      ...
      <KpiCardGrid
        columnsClassName='grid grid-cols-2 gap-2.5 sm:gap-3'
        cardClassName='min-w-0 rounded-2xl border border-border border-l-4 bg-card p-3 shadow-sm sm:p-3.5'
        labelClassName='min-w-0 text-[10px] font-medium uppercase leading-snug tracking-wide text-muted-foreground sm:text-xs sm:tracking-wider'

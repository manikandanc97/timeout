      ...
      <div className='relative z-10 flex min-h-0 flex-1 flex-col gap-3 p-4 sm:gap-4 sm:p-5'>
        <div className='flex min-h-0 min-w-0 flex-1 flex-col gap-3 lg:flex-row lg:items-stretch lg:gap-4'>
          <div className='flex min-h-0 min-w-0 flex-1 flex-col gap-3'>
            ...
            <div className='flex shrink-0 flex-wrap items-start justify-between gap-3'>
              <div className='flex items-start gap-3'>
                ...
                <div className='space-y-2 pt-0.5'>
                  ...
                  <div className='h-8 w-32 max-w-[50vw] animate-pulse rounded-md bg-muted/90' />
            ...
            <section className='flex min-h-0 min-w-0 flex-1 flex-col gap-3 rounded-2xl border border-border bg-card/95 p-3 shadow-sm sm:gap-3.5 sm:p-4'>
              ...
              <div className='flex min-w-0 shrink-0 flex-nowrap items-center gap-3 overflow-x-auto py-1.5 [scrollbar-width:thin]'>
                ...
                <div className='h-10 w-[118px] shrink-0 animate-pulse rounded-xl bg-muted/80 ring-1 ring-border' />
                <div className='ml-auto h-10 w-[118px] shrink-0 animate-pulse rounded-xl bg-muted ring-1 ring-border' />
              </div>
              ...
              <div className='flex flex-col items-stretch justify-between gap-3 border-t border-border pt-2 sm:flex-row sm:items-center'>
                ...
                <div className='flex items-center justify-center gap-2 sm:justify-end'>
                  <div className='h-9 w-9 shrink-0 animate-pulse rounded-lg bg-muted ring-1 ring-border/80' />
                  <div className='h-9 w-9 shrink-0 animate-pulse rounded-lg bg-muted ring-1 ring-border/80' />
                </div>
              </div>
            </section>
            ...
            <section className='flex min-h-0 min-w-0 flex-1 flex-col rounded-2xl border border-border bg-card/95 p-3 shadow-sm sm:p-4'>
              <div className='mb-3 flex shrink-0 flex-wrap items-start justify-between gap-2'>
                <div className='flex min-w-0 flex-1 items-start gap-2.5'>
                  <div className='grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-muted ring-1 ring-border/80' />
                  <div className='min-w-0 space-y-1.5 pt-0.5'>
                    <div className='h-4 w-28 animate-pulse rounded bg-muted/90' />
                    <div className='h-3 w-40 animate-pulse rounded bg-muted' />
                  </div>
                </div>
                <div className='h-9 w-9 shrink-0 animate-pulse rounded-xl border border-border/80 bg-muted' />
              </div>
              <div className='flex min-h-0 max-h-[min(56vh,32rem)] flex-1 flex-col overflow-hidden rounded-xl border border-border bg-muted/40 sm:max-h-[min(60vh,36rem)]'>
                <table className='w-full table-fixed border-collapse text-left text-sm'>
                  <thead className='sticky top-0 z-10'>
                    ...
                    {Array.from({ length: 5 }, (_, i) => (
                      ...
                      >
                        <td className='min-w-0 px-2.5 py-2.5 sm:px-3'>
                          <div
                            className={`h-4 max-w-full animate-pulse rounded bg-muted/90 ${['w-36', 'w-28', 'w-40', 'w-32', 'w-24'][i % 5]}`}
                          />
                        </td>

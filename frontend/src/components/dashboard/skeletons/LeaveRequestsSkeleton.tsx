      ...
      {accents.map((accent, i) => (
        ...
        >
          <div className='flex items-center justify-between gap-2'>
            <div className='h-3 w-14 animate-pulse rounded bg-gray-200/90 sm:w-16' />
        ...
        <div className='flex min-h-0 min-w-0 flex-1 flex-col gap-3'>
          ...
          {/* Inner section: tabs + filters + table + pagination */}
            ...
            >
              ...
              {/* Table shell */}
              <div className='flex min-h-124 flex-1 flex-col overflow-hidden rounded-xl border border-gray-100 bg-gray-50/40'>

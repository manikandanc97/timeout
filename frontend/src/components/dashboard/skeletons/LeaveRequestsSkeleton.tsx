      ...
      {accents.map((accent, i) => (
        ...
        >
          <div className='flex items-center justify-between gap-2'>
            <div className='h-3 w-14 animate-pulse rounded bg-muted/90 sm:w-16' />
            <div className='h-8 w-8 shrink-0 animate-pulse rounded-lg bg-muted sm:h-9 sm:w-9 sm:rounded-xl' />
          </div>
          <div className='mt-2 h-7 w-12 animate-pulse rounded bg-muted/90 sm:mt-2.5 sm:h-8' />
        </div>
      ))}
    </section>
  );
          ...
          <div className='flex shrink-0 flex-wrap items-start justify-between gap-3'>
            <div className='flex items-start gap-3'>
              ...
              <div className='space-y-2 pt-0.5'>
                <div className='h-2.5 w-28 animate-pulse rounded bg-muted/90' />
                <div className='h-8 w-52 max-w-[70vw] animate-pulse rounded-md bg-muted/90' />
                <div className='h-3.5 w-64 max-w-[85vw] animate-pulse rounded bg-muted' />
              </div>
            </div>
            <div className='h-8 w-46 shrink-0 animate-pulse rounded-full border border-border/80 bg-muted/90' />
          </div>
          ...
          {/* Inner section: tabs + filters + table + pagination */}
            ...
            >
              ...
              <div className='flex min-w-0 shrink-0 flex-nowrap items-center gap-3 overflow-x-auto py-0.5 [scrollbar-width:thin]'>
                ...
                <div className='h-10 w-[150px] shrink-0 animate-pulse rounded-md bg-muted/90 ring-1 ring-border' />
                <div className='h-10 w-[170px] shrink-0 animate-pulse rounded-md bg-muted/90 ring-1 ring-border' />
                <div className='h-10 w-[150px] shrink-0 animate-pulse rounded-md bg-muted/90 ring-1 ring-border' />
                <div className='h-10 w-[150px] shrink-0 animate-pulse rounded-md bg-muted/90 ring-1 ring-border' />
                <div className='ml-auto h-10 w-30 shrink-0 animate-pulse rounded-xl bg-muted ring-1 ring-border' />
              </div>
                ...
                <div className='min-h-0 flex-1 overflow-hidden'>
                  ...
                  <div className='sticky top-0 z-10 border-b border-border bg-muted/95 px-4 py-3 backdrop-blur-sm'>
                    <div className='flex gap-3'>
                      <div className='h-3 w-18 animate-pulse rounded bg-muted/80' />
                      <div className='h-3 w-18 animate-pulse rounded bg-muted/80' />
                      <div className='h-3 w-10 animate-pulse rounded bg-muted/80' />
                      <div className='h-3 w-10 animate-pulse rounded bg-muted/80' />
                      <div className='h-3 min-w-0 flex-1 animate-pulse rounded bg-muted/80' />
                    ...
                    {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                      ...
                      >
                        <div className='w-[140px] shrink-0 space-y-1.5'>
                          ...
                          <div className='h-2.5 w-36 animate-pulse rounded bg-muted/80' />
                        </div>
                        <div className='h-6 w-18 shrink-0 animate-pulse rounded-md bg-muted' />
                        <div className='h-3.5 w-17 shrink-0 animate-pulse rounded bg-muted' />
                        <div className='h-3.5 w-17 shrink-0 animate-pulse rounded bg-muted' />
                        <div className='min-w-0 flex-1'>
                          <div className='h-3.5 max-w-[220px] animate-pulse rounded bg-muted' />
                        </div>
                        <div className='h-6 w-18 shrink-0 animate-pulse rounded-full bg-muted' />
                        <div className='ml-auto flex w-28 shrink-0 justify-end gap-2'>
                          <div className='h-7 w-17 animate-pulse rounded-lg bg-muted' />
                          <div className='h-7 w-17 animate-pulse rounded-lg bg-muted' />
                        </div>
                      </div>
                    ))}
              ...
              <div className='flex shrink-0 flex-col items-stretch justify-between gap-3 border-t border-border pt-3 sm:flex-row sm:items-center'>
                ...
                <div className='flex items-center justify-center gap-2 sm:justify-end'>
                  <div className='h-8 w-22 animate-pulse rounded-lg border border-border bg-card shadow-sm' />
                  <div className='h-3 w-20 animate-pulse rounded bg-muted' />
                  <div className='h-8 w-18 animate-pulse rounded-lg border border-border bg-card shadow-sm' />
                </div>
              </div>
            </section>
        </div>

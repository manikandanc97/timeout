    ...
    >
      {accents.map((accent, i) => (
        ...
        >
          ...
          <div className='mt-2 h-7 w-12 animate-pulse rounded bg-gray-200/90 sm:mt-2.5 sm:h-8' />
          {i === 3 ? (
            <div className='mt-1.5 h-2.5 w-24 animate-pulse rounded bg-gray-100/90 sm:w-28' />
          ) : null}
        </div>
      ))}
    </section>

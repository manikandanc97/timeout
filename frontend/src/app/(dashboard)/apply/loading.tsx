            ...
            <div className='flex flex-wrap justify-between items-start gap-4 border-border border-b'>
              <div className='flex items-start gap-3'>
                ...
                <div className='space-y-2'>
                  <div className='bg-skeleton rounded w-20 h-2.5' />
                  <div className='bg-skeleton rounded w-44 h-7' />
                </div>
              </div>
            </div>
            ...
            <div className='gap-5 grid lg:grid-cols-[1.7fr,1fr]'>
              <div className='space-y-5'>
                <div className='gap-4 grid'>
                  ...
                  <section className='bg-card/80 shadow-sm backdrop-blur-sm p-4 md:p-5 border border-border rounded-2xl'>
                    <div className='flex justify-between items-center gap-3'>
                      <div className='bg-skeleton rounded w-40 h-5' />
                      <div className='bg-skeleton rounded-full w-28 h-7' />
                    </div>
                    <div className='gap-3 grid grid-cols-3 mt-3 pb-1'>
                      {[
                        ...
                        >
                          <div className='flex items-start gap-3'>
                            <div className='bg-muted/90 border border-border/80 rounded-lg w-10 h-10 shrink-0' />
                            <div className='flex-1 min-w-0 space-y-2'>
                              <div className='bg-skeleton rounded w-24 h-3' />
                              <div className='bg-skeleton rounded w-[85%] max-w-28 h-2.5' />
                            </div>
                            <div className='bg-muted/80 rounded-md w-9 h-6 shrink-0' />
                          </div>
                        </div>
                      ))}
                    </div>
                  ...
                  <section className='bg-card/80 shadow-sm backdrop-blur-sm p-4 md:p-5 border border-border rounded-2xl'>
                    <div className='flex justify-between items-start gap-3'>
                      <div className='space-y-2'>
                        <div className='bg-skeleton rounded w-24 h-5' />
                        <div className='bg-skeleton rounded w-52 h-3' />
                      </div>
                    ...
                    <div className='gap-3 grid sm:grid-cols-2 mt-4'>
                      {[0, 1].map((i) => (
                        <div key={`date-${i}`} className='space-y-2'>
                          <div className='bg-skeleton rounded w-20 h-3' />
                          <div className='bg-skeleton rounded-md w-full h-10' />
                        </div>
                      ))}
                    </div>
                    <div className='gap-3 grid grid-cols-2 md:grid-cols-4 mt-4'>
                      {[...Array(4)].map((_, i) => (
                        <div
                          key={`stat-${i}`}
                          className='bg-muted px-3 py-2 border border-border rounded-xl text-center'
                        >
                          <div className='bg-skeleton mx-auto mb-2 rounded w-20 h-2.5' />
                          <div className='bg-skeleton mx-auto rounded w-8 h-6' />
                        </div>
                      ))}
                    </div>
                  </section>
                ...
                <section className='bg-card/80 shadow-sm backdrop-blur-sm p-4 md:p-5 border border-border rounded-2xl'>
                  <div className='flex justify-between items-center gap-3'>
                    <div className='space-y-2'>
                      <div className='bg-skeleton rounded w-20 h-5' />
                      <div className='bg-skeleton rounded w-48 h-3' />
                    </div>
                  </div>
                  <div className='mt-4'>
                    <div className='bg-skeleton rounded-md w-full h-18' />
                  </div>
                </section>
                ...
                <section className='flex md:flex-row flex-col md:items-center gap-4 bg-card/90 shadow-sm backdrop-blur-sm p-4 md:p-5 border border-border rounded-2xl'>
                  <div className='flex flex-col flex-1 gap-2'>
                    <div className='bg-skeleton rounded w-[90%] max-w-xs h-3' />
                    <div className='bg-skeleton rounded w-[75%] max-w-52 h-3' />
                  </div>
                  <div className='flex items-center gap-3 md:ml-auto w-full md:w-auto'>
                    <div className='bg-skeleton rounded-lg w-22 h-12' />
                    <div className='bg-skeleton rounded-lg min-w-30 flex-1 md:flex-initial h-12' />
                  </div>
                </section>
              </div>
            </div>
        ...
        <div className='flex flex-col bg-card shadow-md rounded-2xl overflow-hidden'>
          ...
          <div className='flex flex-col flex-1 px-4 pt-4 pb-5'>
            <div className='flex justify-between items-center mb-4'>
              <div className='bg-skeleton rounded-lg w-8 h-8' />
              <div className='space-y-1.5 items-center flex flex-col'>
                <div className='bg-skeleton rounded w-32 h-4' />
            ...
            <div className='gap-1 grid grid-cols-7 mb-1'>
              {[...Array(7)].map((_, i) => (
                <div
                  key={`head-${i}`}
                  className='bg-skeleton mx-auto rounded w-8 h-2.5'
                />
              ))}
            </div>
              ...
              <div className='gap-x-4 gap-y-2 grid grid-cols-2'>
                {[...Array(6)].map((_, i) => (
                  <div key={`legend-${i}`} className='flex items-center gap-2'>
                    <div className='bg-skeleton rounded-full w-2.5 h-2.5 shrink-0' />
                    <div className='bg-skeleton rounded w-24 h-3' />
                  </div>
                ))}
              </div>

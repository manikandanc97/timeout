  ...
  return (
    ...
    >
      <div className='flex min-w-0 flex-1 items-start gap-3.5'>
        <Skeleton className='rounded-xl border border-border w-10 h-10 shrink-0' />
        <div className='flex flex-col flex-1 justify-center mt-0.5 min-w-0'>
          <div className='flex flex-wrap items-center gap-2 mb-1'>
            <Skeleton className='w-28 h-4' />
            <Skeleton className='rounded-full w-16 h-5' />
          </div>
          <Skeleton className='w-48 max-w-full h-3 mb-2' />
          <div className='flex items-start gap-1.5 mt-0.5'>
            <Skeleton className='mt-0.5 w-3.5 h-3.5 shrink-0' />
            <Skeleton className='flex-1 h-10 max-w-md' />
          </div>
        </div>
      </div>
      <div className='flex flex-col justify-between md:items-end gap-3 pt-3 md:pt-0 md:pl-5 border-border border-t md:border-t-0 md:border-l shrink-0'>
        <div className='flex flex-wrap gap-2'>
          <Skeleton className='rounded-md border border-border w-40 h-8' />
          <Skeleton className='rounded-md border border-border w-24 h-8' />
        </div>
        <div className='flex items-center self-start md:self-end gap-2 mt-1'>
          <Skeleton className='rounded-lg border border-border w-8 h-8' />
          <Skeleton className='h-8 w-8 rounded-lg border border-danger-muted-foreground/25' />
        </div>
      </div>
    </div>
  );
        ...
        <div className='flex flex-wrap justify-between items-start gap-4 border-b border-border pb-6'>
          <div className='flex items-start gap-3'>
            ...
            <div className='space-y-2'>
              ...
              <Skeleton className='w-64 max-w-[85vw] h-7' />
            </div>
          </div>
          <div className='flex flex-wrap xl:justify-end items-center gap-2'>
            <Skeleton className='border border-border rounded-full w-44 h-8' />
          </div>
        </div>
        ...
        <div className='flex xl:flex-row flex-col xl:justify-between xl:items-center gap-4'>
          ...
          <div className='flex flex-wrap items-center gap-2'>
            <div className='relative w-full sm:w-[260px]'>
              <Skeleton className='top-1/2 left-3 z-10 absolute w-3.5 h-3.5 -translate-y-1/2' />
              <div className='flex items-center bg-card pl-9 border border-border rounded-xl h-10'>
                <Skeleton className='w-32 h-2.5' />
              </div>
            </div>
            <div className='w-[140px]'>
              <Skeleton className='border border-border w-full h-10 rounded-xl' />
            </div>
